...
plt.ylabel('Temperature Anomaly (°C)')
plt.legend()
plt.savefig(fig_p + 'Fig09_' + time_inc + 'rev011125.png', dpi=300)
plt.savefig(fig_p + 'Fig09_' + time_inc + 'rev011125.eps', dpi=300)
plt.savefig(fig_p + 'Fig09_' + time_inc + 'rev011125.pdf', dpi=300)
plt.show()
