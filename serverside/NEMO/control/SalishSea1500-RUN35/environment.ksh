...
DIR_ARCHI_ATMOS=${HOME}/project/mdunphy/Forcing/OPPWest
...
## ======================================================================
DIR_TMP_HOME=${HOME}/project/mdunphy/nemo_temp/${CONF_NAME}/${CONFIG}
...
## ======================================================================
EXEC_NAME=nemo.exe
BATMET_FIL=bathy_salishsea_1500m_20210208.nc
