...
if [ "$CONF_NAME" == "SalishSea1500" ] ; then
  src=/project/6006412/mdunphy/Forcing/forcing_ciopswbc12_20210406
  ...
  ln -s /project/6006412/mdunphy/Forcing/ss1500tides tides
  ln -s /project/6049289/goldford/data/runoff/rivers_month_20210406_GO.nc .
  ln -s /home/mdunphy/project/mdunphy/Forcing/daily_runoff rivers
  ln -s /home/mdunphy/project/mdunphy/Forcing/ERA5 ERA5
fi
...
echo   --time=${TIMELIMIT} --job-name=$CONF_NBR --mem-per-cpu=${MEMLIMIT} --ntasks=${TOTPROC} ${ACCOUNT} -o ${DIR_TMP_RUN}/nemo.stdout -e ${DIR_TMP_RUN}/nemo.stderr $CONF_NBR.ksh
