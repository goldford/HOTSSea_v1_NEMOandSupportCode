...
if [ "$CONF_NAME" == "SalishSea1500" ] ; then
  src=/project/6006412/mdunphy/input/forcing_ciopswbc12_20201230
  ...
  ln -s /home/mdunphy/project/mdunphy/grid/ss1500tides tides
fi
...
sbatch --time=${TIMELIMIT} --job-name=$CONF_NBR --mem-per-cpu=${MEMLIMIT} --ntasks=${TOTPROC} --account=def-nereusvc $CONF_NBR.ksh 
