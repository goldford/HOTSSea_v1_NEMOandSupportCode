...
runno=$no
typeset -Z3 runno
(rsync -axvH --no-g --no-p ${DIR_TMP_CDF}/*grid_T* $DIR_ARCHI_CDF && rm ${DIR_TMP_CDF}/*grid_T*) >> $DIR_ARCHI_LOG/rsync.R${runno}.grid_T.log &
(rsync -axvH --no-g --no-p ${DIR_TMP_CDF}/*grid_U* $DIR_ARCHI_CDF && rm ${DIR_TMP_CDF}/*grid_U*) >> $DIR_ARCHI_LOG/rsync.R${runno}.grid_U.log &
(rsync -axvH --no-g --no-p ${DIR_TMP_CDF}/*grid_V* $DIR_ARCHI_CDF && rm ${DIR_TMP_CDF}/*grid_V*) >> $DIR_ARCHI_LOG/rsync.R${runno}.grid_V.log &
(rsync -axvH --no-g --no-p ${DIR_TMP_CDF}/*grid_W* $DIR_ARCHI_CDF && rm ${DIR_TMP_CDF}/*grid_W*) >> $DIR_ARCHI_LOG/rsync.R${runno}.grid_W.log &
wait
