...
CONTAINS
   ...
   SUBROUTINE bdy_tra_orlanski( idx, dta, ll_npo )
      ...
      !            
#if defined key_opp
      CALL bdy_orlanski_3d( idx, igrd, tsb(:,:,:,jp_tem), tsa(:,:,:,jp_tem), dta%tem, ll_npo, ll_spg=.false. )
#else
      ...
      !  
#if defined key_opp
      CALL bdy_orlanski_3d( idx, igrd, tsb(:,:,:,jp_sal), tsa(:,:,:,jp_sal), dta%sal, ll_npo, ll_spg=.false. )
#else
