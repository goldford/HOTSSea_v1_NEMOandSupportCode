...
#if defined key_opp
   INTEGER ::   nn_traadv_tvd_zts  !   number of sub-time steps to use with TVD ZTS
#endif
...
#if defined key_opp
      CASE ( 7 )   ;    CALL tra_adv_tvd_zts( kt, nit000, 'TRA', r2dtra, zun, zvn, zwn, tsb, tsn, tsa, jpts, nn_traadv_tvd_zts )   !  TVD ZTS
#else
...
#if defined key_opp
         WRITE(numout,*) '      Number of sub time-steps for TVD ZTS  nn_traadv_tvd_zts = ', nn_traadv_tvd_zts
#endif
      ENDIF
