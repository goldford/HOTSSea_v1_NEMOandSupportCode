...
#if defined key_opp
   SUBROUTINE bdy_orlanski_3d( idx, igrd, phib, phia, phi_ext, ll_npo, ll_spg )
#else
...
#if defined key_opp
         IF ( ll_spg ) THEN
            zey1 = ( (ii-iijm1) * pe_xdif(iijm1+ii_offset,ijjm1          )  &
           &      +  (ij-ijjm1) * pe_ydif(iijm1          ,ijjm1+ij_offset) )
            zey2 = ( (iijp1-ii) * pe_xdif(ii+ii_offset,ij)                  &
           &      +  (ijjp1-ij) * pe_ydif(ii          ,ij+ij_offset) )
         ELSE
#endif
            zey1 = ( (iibm1-iibm1jm1) * pe_xdif(iibm1jm1+ii_offset,ijbm1jm1          )  & 
           &      +  (ijbm1-ijbm1jm1) * pe_ydif(iibm1jm1          ,ijbm1jm1+ij_offset) ) 
...
#if defined key_opp
         IF ( ll_spg ) THEN
            zmask_y1 = ( (ii-iijm1) * pmask_xdif(iijm1+ii_offset,ijjm1          ,jk)   &
           &          +  (ij-ijjm1) * pmask_ydif(iijm1          ,ijjm1+ij_offset,jk) )
            zmask_y2 = ( (iijp1-ii) * pmask_xdif(ii+ii_offset,ij          ,jk)         &
           &          +  (ijjp1-ij) * pmask_ydif(ii          ,ij+ij_offset,jk) )
         ELSE
#endif
...
#if defined key_opp
         IF ( ll_spg ) THEN
            zdy_1 = ( ( phib(ii   ,ij   ,jk) - phib(iijm1,ijjm1,jk) ) / zey1 ) * zmask_y1
            zdy_2 = ( ( phib(iijp1,ijjp1,jk) - phib(ii   ,ij   ,jk) ) / zey2 ) * zmask_y2
         ELSE
#endif
