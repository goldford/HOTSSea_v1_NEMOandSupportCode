...
#from data_conversion_functions import write_to_netcdf #fnction now in this script -GO 2022-12

indir = '/project/6006412/goldford/data/evaluation/nanoose_stn/NANOOSE/**/'
saveDir = '/project/6006412/goldford/data/evaluation/nanoose_stn/prepped_pre2003/'
